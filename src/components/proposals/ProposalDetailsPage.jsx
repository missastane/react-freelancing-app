  ...
  return (
    ...
    >
      ...
      >
        <Box>
          ...
          <Stack direction="row" gap={1} sx={{ mt: 1, flexWrap: "wrap" }}>
            ...
            <Chip
              size="small"
              label={`Deadline: ${proposal.overall_deadline}`}
              variant="outlined"
              sx={{
                borderColor: theme.palette.surface.border,
                bgcolor: theme.palette.surface.soft,
      ...
      >
        ...
        <Divider sx={{ mb: 2, borderColor: theme.palette.surface.border }} />
        ...
        <Divider sx={{ my: 2.5, borderColor: theme.palette.surface.border }} />

        <Typography sx={{ fontWeight: 900 }}>Details</Typography>

        <Typography
          color="text.secondary"
          sx={{ mt: 1, lineHeight: 1.9, whiteSpace: "pre-wrap" }}
        >
          {proposal.details}
        </Typography>
      </Paper>
      ...
      <ProposalDialog
        ...
        onSubmit={(payload) => updateProposal(proposal.id, payload)}
      />
    </Box>
  );
}
